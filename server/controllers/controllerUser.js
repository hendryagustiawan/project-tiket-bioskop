  ...
  static async login(req, res, next) {
    ...
    if (!password && !email) {
      ...
      try {
        ...
        if (user && check) {
          // untuk mendapatkan access_token setelah login
          ...
          // jika terjadi kesalahan inputan dari user
    ...
    client
      ...
      .then((user) => {
        ...
        if (!user) {
          return User.create(
            {
              // punya akun googel tapi tidak punya data di database maka secara default kita akan buatkan data di databse seperti data berikut
